...
// Определение структуры proc_ops
static const struct proc_ops lct_proc_tp_work_pops = {
...
static int lct_creat_proc_tp_entry(void)
{
	lct_tp_p->proc_entry_tp = proc_create_data(TP_WORK_NAME, 0444, NULL, &lct_proc_tp_work_pops, NULL);
