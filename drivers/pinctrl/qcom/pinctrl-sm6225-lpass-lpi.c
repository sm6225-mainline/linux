...
static const struct pinctrl_pin_desc sm6225_lpi_pins[] = {
	PINCTRL_PIN(0, "gpio0"),
	PINCTRL_PIN(1, "gpio1"),
	PINCTRL_PIN(2, "gpio2"),
	PINCTRL_PIN(3, "gpio3"),
...
static const struct lpi_pingroup sm6225_groups[] = {
...
static const struct lpi_function sm6225_functions[] = {
...
static const struct lpi_pinctrl_variant_data sm6225_lpi_data = {
	.pins = sm6225_lpi_pins,
	.npins = ARRAY_SIZE(sm6225_lpi_pins),
...
static const struct of_device_id lpi_pinctrl_of_match[] = {
	{ .compatible = "qcom,sm6225-lpass-lpi-pinctrl", .data = &sm6225_lpi_data },
	{ }
};
...
static struct platform_driver lpi_pinctrl_driver = {
	.driver = {
		.name = "qcom-sm6225-lpass-lpi-pinctrl",
...
MODULE_DESCRIPTION("QTI SM6225 LPI GPIO pin control driver");
MODULE_LICENSE("GPL");
