...
static const struct of_device_id adsp_of_match[] = {
	...
	{ .compatible = "qcom,sm6225-adsp-pas", .data = &adsp_resource_init},
	{ .compatible = "qcom,sm6225-cdsp-pas", .data = &cdsp_resource_init},
	{ .compatible = "qcom,sm6225-mpss-pas", .data = &sc8180x_mpss_resource},
