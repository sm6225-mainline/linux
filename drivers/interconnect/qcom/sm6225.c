...
enum {
	...
	SM6225_MASTER_SNOC_BIMC,
	SM6225_MASTER_SNOC_CFG,
	SM6225_MASTER_SNOC_CNOC,
	SM6225_MASTER_TCU_0,
	SM6225_MASTER_TIC,
	SM6225_MASTER_USB3,
...
static struct qcom_icc_node qhs_apss_throttle_cfg = {
	...
	.id = SM6225_SLAVE_APSS_THROTTLE_CFG,
	.channels = 1,
	.buswidth = 4,
	.mas_rpm_id = -1,
	.slv_rpm_id = -1,
...
static struct qcom_icc_node qhs_gpu_throttle_cfg = {
	...
	.id = SM6225_SLAVE_GPU_THROTTLE_CFG,
	.channels = 1,
	.buswidth = 4,
	.mas_rpm_id = -1,
	.slv_rpm_id = -1,
...
static const struct qcom_icc_desc sm6225_clk_virt = {
	.type = QCOM_ICC_QNOC,
...
static const struct of_device_id qnoc_of_match[] = {
	...
	{ .compatible = "qcom,sm6225-clk-virt", .data = &sm6225_clk_virt },
	{ .compatible = "qcom,sm6225-cnoc", .data = &sm6225_config_noc },
	{ .compatible = "qcom,sm6225-mmrt-virt", .data = &sm6225_mmrt_virt },
	{ .compatible = "qcom,sm6225-mmnrt-virt", .data = &sm6225_mmnrt_virt },
	{ .compatible = "qcom,sm6225-snoc", .data = &sm6225_sys_noc },
	{ }
};
...
MODULE_DESCRIPTION("SM6225 NoC driver");
MODULE_LICENSE("GPL");
